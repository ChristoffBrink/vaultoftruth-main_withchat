    ...
    if request.method == 'POST':
        if questions:
            if len(questions) <= 8:
                ...
                p.drawImage('/home/christoffbrink/vaultoftruth-main_withchat/Seal.png', -18, -18, width=625, height=870, mask='auto')
                p.drawImage('/home/christoffbrink/vaultoftruth-main_withchat/Seal2.png', 227, 80, width=130, height=130, mask='auto')
                pdfmetrics.registerFont(TTFont('abc',r'/home/christoffbrink/vaultoftruth-main_withchat/IndentureEnglishPenmanDemo-Xdyj.ttf'))
                p.setFont('abc', 63)
